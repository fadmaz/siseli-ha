...
class TestValidateConfig(unittest.TestCase):
    ...
    @mock.patch("src.siseli_local_bridge.config.os.makedirs")
...
class TestDerivedTopics(unittest.TestCase):
    """The defaults shipped a literal naming siseli_local_inverter_1, so Supervisor always
...
class TestDeviceIdSanitisation(unittest.TestCase):
    ...
    def test_an_empty_id_falls_back_to_the_default(self):
        self.assertEqual(reload_config(DEVICE_ID="").DEVICE_ID, "siseli_local_inverter_1")
